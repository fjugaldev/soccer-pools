...
final class Version20190513135405 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE group_teams (team_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_C6EE093F296CD8AE (group_id), INDEX IDX_C6EE093FFE54D947 (team_id), PRIMARY KEY(group_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
