 ...
 */
final class Version20190705142024 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE group_teams (group_id INT NOT NULL, team_id INT NOT NULL, INDEX IDX_C6EE093FFE54D947 (group_id), INDEX IDX_C6EE093F296CD8AE (team_id), PRIMARY KEY(group_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
