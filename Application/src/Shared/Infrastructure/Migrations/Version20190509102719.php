...
final class Version20190509102719 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `tournament_group` (id INT AUTO_INCREMENT NOT NULL, tournament_id INT DEFAULT NULL, name VARCHAR(25) NOT NULL, group_letter VARCHAR(2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_6DC044C533D1A3E7 (tournament_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `tournament_match` (id INT AUTO_INCREMENT NOT NULL, visitor_id INT DEFAULT NULL, home_id INT DEFAULT NULL, tournament_id INT DEFAULT NULL, tournament_group_id INT DEFAULT NULL, phase_id INT DEFAULT NULL, visitor_score INT NOT NULL, home_score INT NOT NULL, date DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_7A5BC50570BEE6D (visitor_id), INDEX IDX_7A5BC50528CDC89C (home_id), INDEX IDX_7A5BC50533D1A3E7 (tournament_id), INDEX IDX_7A5BC505FE54D947 (group_id), INDEX IDX_7A5BC50599091188 (phase_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tournament_pool (id INT AUTO_INCREMENT NOT NULL, tournament_it INT DEFAULT NULL, owner_id INT DEFAULT NULL, description LONGTEXT NOT NULL, private TINYINT(1) DEFAULT \'0\' NOT NULL, access_code VARCHAR(255) DEFAULT NULL, max_players INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_981C1BB82E66B383 (tournament_it), INDEX IDX_981C1BB87E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE group_teams ADD CONSTRAINT FK_C6EE093F33D1A3E7 FOREIGN KEY (tournament_id) REFERENCES `tournament_group` (id)');
        $this->addSql('ALTER TABLE group_teams ADD CONSTRAINT FK_C6EE093FFE54D947 FOREIGN KEY (group_id) REFERENCES team (id)');
        $this->addSql('ALTER TABLE `tournament_match` ADD CONSTRAINT FK_7A5BC50570BEE6D FOREIGN KEY (visitor_id) REFERENCES team (id)');
        $this->addSql('ALTER TABLE `tournament_match` ADD CONSTRAINT FK_7A5BC50528CDC89C FOREIGN KEY (home_id) REFERENCES team (id)');
        $this->addSql('ALTER TABLE `tournament_match` ADD CONSTRAINT FK_7A5BC50533D1A3E7 FOREIGN KEY (tournament_id) REFERENCES tournament (id)');
        $this->addSql('ALTER TABLE `tournament_match` ADD CONSTRAINT FK_7A5BC505FE54D947 FOREIGN KEY (group_id) REFERENCES `tournament_group` (id)');
        $this->addSql('ALTER TABLE `tournament_match` ADD CONSTRAINT FK_7A5BC50599091188 FOREIGN KEY (phase_id) REFERENCES tournament_phase (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `tournament_match` DROP FOREIGN KEY FK_7A5BC505FE54D947');
        ...
        $this->addSql('ALTER TABLE `tournament_match` DROP FOREIGN KEY FK_7A5BC50570BEE6D');
        $this->addSql('ALTER TABLE `tournament_match` DROP FOREIGN KEY FK_7A5BC50528CDC89C');
        $this->addSql('ALTER TABLE tournament_teams DROP FOREIGN KEY FK_5794B241296CD8AE');
        $this->addSql('ALTER TABLE `tournament_group` DROP FOREIGN KEY FK_6DC044C533D1A3E7');
        $this->addSql('ALTER TABLE `tournament_match` DROP FOREIGN KEY FK_7A5BC50533D1A3E7');
        ...
        $this->addSql('ALTER TABLE `tournament_match` DROP FOREIGN KEY FK_7A5BC50599091188');
