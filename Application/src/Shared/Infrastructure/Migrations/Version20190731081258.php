...
namespace InnovatikLabs\Shared\Infrastructure\Migrations;
 ...
 */
final class Version20190731081258 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tournament_group (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', tournament_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', name VARCHAR(25) NOT NULL, group_letter VARCHAR(2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_AC96D4DC33D1A3E7 (tournament_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE group_teams (group_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', team_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', INDEX IDX_C6EE093FFE54D947 (group_id), INDEX IDX_C6EE093F296CD8AE (team_id), PRIMARY KEY(group_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pool_ticket (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', pool_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', match_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', player_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', visitor_score INT NOT NULL, home_score INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_4228D23D7B3406DF (pool_id), INDEX IDX_4228D23D2ABEACD6 (match_id), INDEX IDX_4228D23D99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, discr VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64992FC23A8 (username_canonical), UNIQUE INDEX UNIQ_8D93D649A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_8D93D649C05FB297 (confirmation_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament_pool (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', tournament_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', owner_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', name VARCHAR(120) NOT NULL, description LONGTEXT NOT NULL, private TINYINT(1) NOT NULL, access_code VARCHAR(255) DEFAULT NULL, max_players INT NOT NULL, hit_victory_points INT NOT NULL, hit_tie_points INT NOT NULL, hit_score_points INT NOT NULL, hit_home_score_points INT NOT NULL, hit_visitor_score_points INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_981C1BB833D1A3E7 (tournament_id), INDEX IDX_981C1BB87E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament_pool_players (pool_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', player_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', INDEX IDX_A7AE09CC7B3406DF (pool_id), INDEX IDX_A7AE09CC99E6F5DF (player_id), PRIMARY KEY(pool_id, player_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament_phase (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', tournament_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', name VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_70EB46D233D1A3E7 (tournament_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE team (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', name VARCHAR(100) NOT NULL, fifa_code VARCHAR(3) NOT NULL, iso2 VARCHAR(2) NOT NULL, flag VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', federation_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', name VARCHAR(120) NOT NULL, description LONGTEXT NOT NULL, from_date DATETIME NOT NULL, to_date DATETIME NOT NULL, logo VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_BD5FB8D96A03EFC5 (federation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament_teams (tournament_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', team_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', INDEX IDX_5794B24133D1A3E7 (tournament_id), INDEX IDX_5794B241296CD8AE (team_id), PRIMARY KEY(tournament_id, team_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tournament_match (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', visitor_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', home_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', tournament_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', group_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', phase_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid_binary)\', visitor_score INT NOT NULL, home_score INT NOT NULL, date DATETIME NOT NULL, started TINYINT(1) DEFAULT \'0\' NOT NULL, ended TINYINT(1) DEFAULT \'0\' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_BB0D551C70BEE6D (visitor_id), INDEX IDX_BB0D551C28CDC89C (home_id), INDEX IDX_BB0D551C33D1A3E7 (tournament_id), INDEX IDX_BB0D551CFE54D947 (group_id), INDEX IDX_BB0D551C99091188 (phase_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE federation (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', name VARCHAR(150) NOT NULL, logo VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE group_teams ADD CONSTRAINT FK_C6EE093FFE54D947 FOREIGN KEY (group_id) REFERENCES tournament_group (id)');
